...
class player(object):
    def __init__(self,playerId,totalProduction):
...
for i in range(len(tileslist)):
    print('Tile ID: ', tileslist[i].tileid)
    print('Resource: ',tileslist[i].resource)
    print('Roll Number: ', tileslist[i].rollnumber)
    print('')
...
for i in range(len(vertslist)):
    print('Vertex ID: ', vertslist[i].vertid)
    print('Adj Hex: ', vertslist[i].adjhex)
    print('Adj Vert: ', vertslist[i].adjvert)
    print('Production: ', vertslist[i].production)
    print('')
...
print(findBestPlaces(vertslist))